...
const TIERS = [
  ...
  },
  {
    ...
    bonuses: ["펜션 10만원 할인", "공방 시설 무료 이용"],
    cta: "원데이 세미나 신청",
    highlight: true,
  },
  {
    ...
    bonuses: ["펜션 10만원 할인", "CNC 공방 무료 이용", "졸업 후 원데이 세미나 전환 우대", "코칭프로 자격 + 수익쉐어 강사 참여"],
    cta: "퍼널구축 아카데미 신청",
    highlight: false,
  },
];
...
const BOOTCAMP = {
  ...
  benefits: [
    ...
    { text: "펜션 10만원 할인", sub: "달팽이 아지트 펜션 이용 시" },
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px", minWidth: "700px" }}>
                ...
                <tbody>
                  {[
                    ...
                    ["라이브 시연 + 녹화본", "—", "✓", "✓", "✓ (평생 소장)"],
                    ["커뮤니티 + 템플릿", "—", "✓", "✓", "✓"],
                    ["내 결과물 가져가기", "—", "—", "✓ (과목별)", "✓ (자동화 6개)"],
                    ["이론 + 실습 구조", "—", "—", "✓ (3h+3h)", "✓ (3h+2h)"],
                    ["녹화본 평생 소장", "—", "—", "✓", "✓"],
                    ["자동화 시스템 직접 구축", "—", "—", "—", "✓ (6개)"],
                    ["온라인 멤버십 포함", "—", "—", "—", "✓ (3개월)"],
                    ["구축 대행 할인", "—", "—", "15%", "15%"],
                    ["펜션·공방 혜택", "—", "—", "할인 이용", "펜션 10만원 + 공방 무료"],
                    ["졸업 후 상위 단계 전환 우대", "—", "—", "—", "✓"],
                    ["코칭프로 자격 + 수익쉐어 강사 참여", "—", "—", "—", "✓"],
                    ["정원", "무제한", "—", "50명", "30명"],
                  ].map((row, ri) => (
