...
const TIERS = [
  ...
  },
  {
    ...
    name: "퍼널구축 아카데미",
    grade: "집중 스터디반",
    subtitle: "4주 만에 내 사업의 자동화 퍼널을 완성합니다",
    price: "₩990,000",
    ...
    bonuses: ["펜션 20% 할인", "CNC 공방 무료 이용", "졸업 후 프로 멤버십 전환 우대"],
    cta: "퍼널구축 아카데미 신청",
    highlight: false,
  },
];
...
const FUNNEL_STEPS = [
  ...
  {
    step: "STEP 5", emoji: "🏗️", label: "자동화 통째로 맡기기",
  ...
  {
    step: "STEP 6", emoji: "📦", label: "바로구매 서비스",
    keyword: "예약 · 챗봇 · 리뷰 · 문자 · 대시보드",
    sub: "설치 없이 바로 쓰는 자동화 SaaS. 내 가게에 오늘 당장 적용",
    price: "월 ₩19,000~", color: "#0F6E56",
    detail: "SOLD OUT / 대기자 등록 중",
  },
];
